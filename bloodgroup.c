...
{ char Name[50], G[5], answer[20];
  ...
  do
  {
    ...
    do
    {
      printf("What is your blood group [A, B, AB, O, don't know]? ");
      scanf("%s", G);
      ...
      if (strcmp(G, "A") !=0  &&
                            ...
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 )
        printf("Blood group %s is invalid! Please try again.\n", G); // changes from User B from 'incorrect' to 'invalid'
    }  while (strcmp(G, "A") !=0  &&
                            strcmp(G, "B") !=0  &&
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 );
    if (strcmp(G,"A") ==0)
    {
      printf("%s, A. You can give blood to: A, AB.\n", Name); // changes from User B from "Hey, you can..." to "You can..."
